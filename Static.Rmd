...
<span style="color:blue"> Discuss vampire bat work of Gerald Wilkinson (1984) *Nature* </span>
...
**SKIPPED THE DEFINITION BELOW - Needs to be updated**
...
Thusfar, we have only considered static games, but evolution is, by definition, a dynamic process in which frequencies of genotypes change over time. To account for this dynamic, we will model the dynamics of two competing genotypes. 
...
*How might one check for stability?*
