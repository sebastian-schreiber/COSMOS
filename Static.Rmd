...
When $pb>a$, we get a hawk-dove game in which playing a strategy different from your opponent is best. Assume this holds. If $x$ is the frequency of dwarves in the population, then the payoff functions of interacting with a random individual from the population are given by 
\[
\begin{aligned}
...
Lets try this out for parameter values satisfying $pb>a$: 
